            ...
            {isMobile ? (
                <div className="h-full w-full relative">
                    ...
                    <div className="absolute top-0 left-0 right-0 z-30 safe-area-top">
                        <div className="mx-3 mt-3 px-4 py-3 bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/50">
                            {/* 城市名称 + 行程概览 */}
                            <div className="flex items-center justify-between mb-2.5">
                                <div className="flex items-center gap-2">
                                    <span className="text-lg">📍</span>
                                    <div>
                                        <h1 className="font-bold text-slate-800 text-base leading-tight">{tripPlan.meta.city}</h1>
                                        <p className="text-[10px] text-slate-500 line-clamp-1">{tripPlan.meta.trip_title}</p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-center gap-1.5 overflow-x-auto pb-0.5 -mx-1 px-1 scrollbar-hide">
                                <button
                                    ...
                                    className={`shrink-0 flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-semibold transition-all touch-feedback ${selectedDay === null
                                ...
                                {tripPlan.timeline.map((day, index) => (
                                    <button
                                        ...
                                        className={`shrink-0 flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-semibold transition-all touch-feedback ${selectedDay === index
