...
import { Clock, MapPin, Utensils, Camera, AlertTriangle, Wallet, Loader2, Bus, Train, Footprints, Car } from 'lucide-react';
...
// Image component with Unsplash hook
// Helper component for loading images - 支持 SSR 模式 (当传入 resolvedImageUrl 时不使用 Hook)
...
export default function DayDetailExportView({
    dayPlan,
    meta,
    className = '',
    id,
